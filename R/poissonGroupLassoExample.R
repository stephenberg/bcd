...
# fitgrpreg=grpreg(X[,2:dim(X)[2]],response,group=c(rep(1,4),rep(2,10),rep(3,5),rep(4,2),rep(5,3),rep(6,5)),family="poisson",eps=10^-16,lambda.min=0.05,lambda=fitDense0$lambda*sqrt(n))
